...
<!-- sls styles -->
<link rel="stylesheet" type="text/css" media="screen" href="{@RELATIVE_SLS_DIR}style/storyLibrary{if PAGE_DIRECTION == 'rtl'}-rtl{/if}.css" />
...
<script type="text/javascript">
	...
	var RELATIVE_SLS_DIR = '{@RELATIVE_SLS_DIR}';
