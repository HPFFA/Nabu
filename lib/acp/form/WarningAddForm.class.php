...
class WarningAddForm extends ACPForm {
	...
	public $activeMenuItem = 'sls.acp.menu.link.content.warning.add';
	public $neededPermissions = 'admin.library.canAddWarning';
	...
	public function save() {
		parent::save();
		// save library
		if (WCF::getUser()->getPermission('admin.library.canAddWarning')) {
			$this->warning = WarningEditor::create($this->title, $this->description,
