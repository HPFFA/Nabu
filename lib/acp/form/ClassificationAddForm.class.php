...
/**
 * Shows the classification add form.
 * 
 * @author 	Jana Pape
 * @copyright	2010
 ...
 */
class ClassificationAddForm extends ACPForm {
	// system
	public $templateName = 'classificationAdd';
	public $activeMenuItem = 'sls.acp.menu.link.content.classification.add';
	public $neededPermissions = 'admin.library.canAddClassification';
	
	/**
	 * classification editor object
	 * 
	 * @var	ClassificationEditor
	 */
	public $classifiaction;
	/**
	...
	public function save() {
		parent::save();
		// save library
		if (WCF::getUser()->getPermission('admin.library.canAddClassification')) {
			$this->classification = ClassificationEditor::create($this->title, $this->description,
